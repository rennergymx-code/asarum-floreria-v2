...
const Navbar: React.FC<NavbarProps> = ({ cartCount, season, announcement }) => {
  const getThemeColor = () => {
    switch (season) {
  ...
  return (
    <header className="sticky top-0 z-50">
      <AnnouncementBar message={announcement} season={season} />
      <nav className="glass-morphism shadow-lg">
