    ...
    <footer className={`${isValentines ? 'bg-red-950' : 'bg-gray-900'} text-white py-16`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="space-y-8">
          <h3 className="text-lg font-bold mb-4 border-b border-asarum-red/30 pb-2 inline-block uppercase tracking-widest">Nuestras Sucursales</h3>
        ...
        <div>
          <h3 className="text-lg font-bold mb-4 uppercase tracking-widest">Información de Envío</h3>
